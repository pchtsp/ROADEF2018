...
class TestHeuristic(unittest.TestCase):
    ...
    def check_node_order(self, node1, node2, case, expected):
        ...
        order = nd.check_node_order(node1, node2)
    ...
    def test_check_swap_defects_sq1(self):
        expected = [
            {0: [
                {'DL': {'X': 289, 'Y': 0}, 'UR': {'X': 289+321, 'Y': 691}},
                {'DL': {'X': 6000-382-382, 'Y': 1269}, 'UR': {'X': 6000-382, 'Y': 3210-224}}
            ]},
            {0: [
                {'DL': {'X': 6000-382-382, 'Y': 0}, 'UR': {'X': 6000-382-382+321, 'Y': 691}},
                {'DL': {'X': 6000-382-382, 'Y': 1269+224}, 'UR': {'X': 6000-382, 'Y': 3210}}
            ]}
        ]
    ...
    def no_test_check_swap_defects_sq2(self):
        expected = [
            {0: [
                {'DL': {'X': 610, 'Y': 705+1684}, 'UR': {'X': 610+843, 'Y': 705+1684+821}},
                {'DL': {'X': 610, 'Y': 705}, 'UR': {'X': 610+864, 'Y': 705+1684}}
            ]},
            {0: [
                {'DL': {'X': 610, 'Y': 0}, 'UR': {'X': 610+843, 'Y': 821}},
                {'DL': {'X': 610, 'Y': 821}, 'UR': {'X': 610+864, 'Y': 821+1684}}
            ]}
        ]
    ...
    def test_check_swap_defects_sq4(self):
        expected = [
            {1: [
                {'DL': {'X': 864, 'Y': 402}, 'UR': {'X': 864+1259, 'Y': 402+2128}},
                {'DL': {'X': 864, 'Y': 402 + 2128}, 'UR': {'X': 864 + 1009, 'Y': 3210 - 278}},
                {'DL': {'X': 864 + 416, 'Y': 0}, 'UR': {'X': 864 + 416 + 843, 'Y': 402}},
                {'DL': {'X': 6000-824-31-1398, 'Y': 964}, 'UR': {'X': 6000-824-31, 'Y': 3210-80}}
            ]},
            {1: [
                {'DL': {'X': 864, 'Y': 0}, 'UR': {'X': 864+1259, 'Y': 2128}},
                {'DL': {'X': 864, 'Y': 2128}, 'UR': {'X': 864 + 1009, 'Y': 2128+402}},
                {'DL': {'X': 6000-824-31-1398+416, 'Y': 0}, 'UR': {'X': 6000-824-31-1398+416 + 843, 'Y': 402}},
                {'DL': {'X': 6000-824-31-1398, 'Y': 964+80}, 'UR': {'X': 6000-824-31, 'Y': 3210}}
            ]}
        ]
    ...
    def test_check_swap_defects_sq6(self):
        expected = [
            {1: [
                {'DL': {'X': 6000-824, 'Y': 1009+1259}, 'UR': {'X': 6000-528, 'Y': 1009+1259+584}},
                {'DL': {'X': 6000 - 824 - 31 - 1398, 'Y': 964}, 'UR': {'X': 6000 - 824 - 31, 'Y': 3210 - 80}}
            ]},
            {1: [
                {'DL': {'X': 6000 - 824 - 31 - 1398, 'Y': 0}, 'UR': {'X': 6000 - 824 - 31 - 1398+296, 'Y': 584}},
                {'DL': {'X': 6000 - 824 - 31 - 1398, 'Y': 784}, 'UR': {'X': 6000 - 824 - 31, 'Y': 784+2166}}
            ]}
        ]
    ...
    def test_check_swap_defects_sq7(self):
        expected = [
            {2: [
                {'DL': {'X': 947+1398+821+602, 'Y': 0}, 'UR': {'X': 947+1398+821+602+496, 'Y': 784}}
            ]},
            {2: [
                {'DL': {'X': 947, 'Y': 130+2166}, 'UR': {'X': 947+784, 'Y': 130+2166+496}}
            ]}
        ]
    ...
    def test_check_swap_defects_A2_3_sq(self):
        ...
        expected = [
            {4: [
                {'DL': {'X': 6000 - 1077, 'Y': 0}, 'UR': {'X': 6000-621, 'Y': 469}},
                {'DL': {'X': 6000 - 1077, 'Y': 469+296}, 'UR': {'X': 6000-139-469, 'Y': 3210-1989}},
                {'DL': {'X': 6000 - 139-469, 'Y': 469 + 296}, 'UR': {'X': 6000 - 139, 'Y': 3210 - 1989}},
                {'DL': {'X': 6000 - 1077, 'Y': 3210-1989}, 'UR': {'X': 6000, 'Y': 3210}}
            ],
            1: [
                {'DL': {'X': 6000 - 3371, 'Y': 0}, 'UR': {'X': 6000, 'Y': 810}},
                {'DL': {'X': 6000 - 3371, 'Y': 810}, 'UR': {'X': 6000 - 65, 'Y': 810 + 803}},
                {'DL': {'X': 6000 - 3371, 'Y': 810 + 803}, 'UR': {'X': 6000, 'Y': 3210 - 423 - 364}},
                {'DL': {'X': 6000 - 3371, 'Y': 3210 - 423}, 'UR': {'X': 6000 - 2462, 'Y': 3210}},
                {'DL': { 'X': 1288+47, 'Y': 0}, 'UR': {'X': 1288 +47+469, 'Y': 456}},
                {'DL': { 'X': 1288 + 47, 'Y': 456+286}, 'UR': {'X': 1288 + 47 + 746, 'Y': 456+286+426}},
                {'DL': { 'X': 1288 + 47, 'Y': 456 + 286+426}, 'UR': {'X': 1288 + 47 + 456, 'Y': 3210-1573}},
                {'DL': { 'X': 1288 + 47, 'Y': 3210-1573}, 'UR': {'X': 6000-3371, 'Y': 3210}},
            ]
            },
            {4: [
                {'DL': {'X': 6000 - 1294, 'Y': 0}, 'UR': {'X': 6000 - 825, 'Y': 456}},
                {'DL': {'X': 6000 - 1294, 'Y': 456+286}, 'UR': {'X': 6000-548, 'Y': 456+286+426}},
                {'DL': {'X': 6000 - 1294, 'Y': 456+286+426}, 'UR': {'X': 6000 - 838, 'Y': 3210 - 1573}},
                {'DL': {'X': 6000 - 1294, 'Y': 3210-1573}, 'UR': {'X': 6000, 'Y': 3210}}
            ],
            1: [
                {'DL': {'X': 1288+47, 'Y': 0}, 'UR': {'X': 1288 +47+456, 'Y': 469}},
                {'DL': {'X': 1288 + 47, 'Y': 469+296}, 'UR': {'X': 1288 + 47 + 469, 'Y': 3210-1989}},
                {'DL': {'X': 1288 + 47+ 469, 'Y': 469 + 296}, 'UR': {'X': 1288 + 47 + 469+469, 'Y': 3210-1989}},
                {'DL': {'X': 1288 + 47, 'Y': 3210-1989}, 'UR': {'X': 1288 + 47+1077, 'Y': 3210}},
                {'DL': {'X': 6000-3371+dif_width, 'Y': 0}, 'UR': {'X': 6000+dif_width, 'Y': 810}},
                {'DL': {'X': 6000 - 3371+dif_width, 'Y': 810}, 'UR': {'X': 6000-65+dif_width, 'Y': 810+803}},
                {'DL': {'X': 6000 - 3371+dif_width, 'Y': 810+803}, 'UR': {'X': 6000+dif_width, 'Y': 3210-423-364}},
                {'DL': {'X': 6000 - 3371+dif_width, 'Y': 3210-423}, 'UR': {'X': 6000-2462+dif_width, 'Y': 3210 }},
            ],
            }
        ]
    ...
    def test_order_1(self):
        return self.check_node_order(49, 46, 'A6', False)
